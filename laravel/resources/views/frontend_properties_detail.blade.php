        ...
        <div class="container">
            ...
            <div class="list-single-opt_header fl-wrap">
                <ul class="list-single-opt_header_cat">
                    <li><a href="{{ route('properties.index') }}" class="cat-opt blue-bg">{{ $property->category->category }}</a></li>
                    <li><a href="{{ route('properties.index') }}" class="cat-opt color-bg">{{ $property->created_at->diffForHumans() }}</a></li>
                </ul>
            </div>
