...
<div class="content">
    ...
    <section class="gray-bg small-padding ">
        <div class="container">
            <div class="mob-nav-content-btn  color-bg show-list-wrap-search ntm fl-wrap">Hiện bộ lọc</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="listsearch-input-item  ">
                                <input type="text" placeholder="Địa chỉ, tên đường, thành phố..." value="" />
                            </div>
                        </div>
                        <!-- listsearch-input-item -->
                        <!-- listsearch-input-item -->
                        <div class="col-sm-3">
                            <div class="listsearch-input-item">
                                <select data-placeholder="Trạng thái" class="chosen-select on-radius no-search-select">
                                    <option>Bất kỳ trạng thái</option>
                        ...
                        <div class="col-sm-3">
                            <div class="listsearch-input-item">
                                <select data-placeholder="Tất cả các thành phố"
                                    class="chosen-select on-radius no-search-select">
                                    <option>Tất cả các thành phố</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <div class="listsearch-input-item">
                                    ...
                                    <select data-placeholder="Phòng ngủ"
                                        class="chosen-select on-radius no-search-select">
                                        <option>1</option>
                                        <option>2</option>
                                        <option>3</option>
                            ...
                            <div class="col-sm-2">
                                <div class="listsearch-input-item">
                                    ...
                                    <select data-placeholder="Phòng tắm"
                                        class="chosen-select on-radius no-search-select">
                                        <option>1</option>
                                        <option>2</option>
                                        <option>3</option>
                                ...
                                <div class=" fl-wrap filter-tags">
                                    <ul class="no-list-style">
                                        ...
                                        <li>
                                            ...
                                            <label for="check-d">Điều hòa nhiệt độ</label>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <label for="check-d6">Garage đính kèm</label>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <label for="check-d9">Rèm cửa</label>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="pagination">
                                ...
                                <a href="{{ $properties->nextPageUrl() }}" class="nextposts-link"><i
