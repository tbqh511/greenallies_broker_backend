        ...
        <div class="geodir-category-content fl-wrap">
            ...
            <div class="geodir-category-footer fl-wrap">
                <a href="{{ route('agent.showid', ['id' => $productCard->added_by]) }}" class="gcf-company">
                        <img src="{{$productCard->agent ? ($productCard->agent->profile ? $productCard->agent->profile : 'https://dalatbds.com/images/users/1693209486.1303.svg'):'https://dalatbds.com/images/users/1693209486.1303.svg'}}" alt="Đà Lạt BDS">
